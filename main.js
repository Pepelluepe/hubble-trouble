...
["base64", "script/base64.dart", , D, {
  ...
  base64DecToArr: function(sBase64) {
    var sB64Enc, t1, nInLen, nOutLen, t2, taBytes, nMod3, nUint24, nOutIdx, nInIdx, nMod4, t3;
    sB64Enc = J.replaceAll$2$s(sBase64, $.get$baseRegexp(), "");
    t1 = J.getInterceptor$asx(sB64Enc);
    nInLen = t1.get$length(sB64Enc);
    nOutLen = C.JSNumber_methods._shrOtherPositive$1(J.$mul$ns(nInLen, 3) + 1, 2);
    t2 = H._checkLength(nOutLen);
    taBytes = new Uint8Array(t2);
    if (typeof nInLen !== "number")
      return H.iae(nInLen);
    nMod3 = null;
    nUint24 = 0;
    nOutIdx = 0;
    ...
    for (; nInIdx < nInLen; ++nInIdx) {
      nMod4 = nInIdx & 3;
      t3 = t1.codeUnitAt$1(sB64Enc, nInIdx);
      if (t3 > 64 && t3 < 91)
        t3 -= 65;
      else if (t3 > 96 && t3 < 123)
        t3 -= 71;
      else if (t3 > 47 && t3 < 58)
        t3 += 4;
      else if (t3 === 43)
        ...
        t3 = t3 === 47 ? 63 : 0;
      nUint24 = (nUint24 | C.JSInt_methods.$shl(t3, 18 - 6 * nMod4)) >>> 0;
      if (nMod4 === 3 || nInLen - nInIdx === 1) {
        nMod3 = 0;
        while (true) {
          if (!(nMod3 < 3 && nOutIdx < nOutLen))
            break;
          t3 = C.JSInt_methods._shrBothPositive$1(nUint24, C.JSInt_methods._shrBothPositive$1(16, nMod3) & 24);
          if (nOutIdx < 0 || nOutIdx >= t2)
            return H.ioore(taBytes, nOutIdx);
          taBytes[nOutIdx] = t3 & 255;
          ++nMod3;
          ++nOutIdx;
        }
        nUint24 = 0;
...
["dart.async", "dart:async", , P, {
  ...
  }, "call$1", "_AsyncRun__scheduleImmediateWithSetImmediate$closure", 2, 0, 10],
  ...
  Future_wait_handleError: {
    "^": "Closure:38;box_0,eagerError_1,result_2",
    ...
    }, "call$2", null, 4, 0, null, 44, 45, "call"]
  },
  Future_wait_closure: {
    "^": "Closure:46;box_0,eagerError_3,result_4,pos_5",
  ...
  _Future__propagateToListeners_handleValueCallback: {
    "^": "Closure:48;box_1,listener_3,sourceValue_4,zone_5",
    call$0: function() {
  ...
  _ForwardingStreamSubscription: {
    ...
    }, "call$2", "get$_handleError", 4, 0, 53, 16, 17],
...
["dart.collection", "dart:collection", , P, {
  ...
  ListMixin: {
    ...
    setRange$4: function(receiver, start, end, iterable, skipCount) {
      ...
      if (start > this.get$length(receiver))
        H.throwExpression(P.RangeError$range(start, 0, this.get$length(receiver), null, null));
      if (end < start || end > this.get$length(receiver))
        H.throwExpression(P.RangeError$range(end, start, this.get$length(receiver), null, null));
      $length = end - start;
      if ($length === 0)
        return;
  ...
  SetMixin: {
    ...
    addAll$1: function(_, elements) {
      var t1;
      for (t1 = new H.ListIterator(elements, 5, 0, null); t1.moveNext$0();)
...
["dart.dom.html", "dart:html", , W, {
  ...
  CanvasRenderingContext2D: {
    "^": "Interceptor;canvas=,fillStyle},font},imageSmoothingEnabled}",
...
["dart.js", "dart:js", , P, {
  ...
  JsArray: {
    ...
    setRange$4: function(_, start, end, iterable, skipCount) {
      ...
      if (start > t1)
        H.throwExpression(P.RangeError$range(start, 0, t1, null, null));
      if (end < start || end > t1)
        H.throwExpression(P.RangeError$range(end, start, t1, null, null));
      $length = end - start;
      if ($length === 0)
        return;
      args = [start, $length];
...
["drawing", "script/drawing.dart", , V, {
  ...
  onResize: [function(e) {
    ...
    t2 = document.body;
    t2.toString;
    t2 = C.JSNumber_methods.toInt$0(Math.ceil(C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t2.clientWidth)) / 1));
    $._width = t2;
    J.set$width$x(t1, t2);
    t2 = $._can;
    t1 = document.body;
    t1.toString;
    t1 = C.JSNumber_methods.toInt$0(Math.ceil(C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1.clientHeight)) / 1));
    $._height = t1;
...
["drawutils", "script/drawutils.dart", , N, {
  ...
  blur: function(context, radius) {
    var t1, width, height, imageData, pixels, div, widthMinus1, heightMinus1, radiusPlus1, sumFactor, stackStart, stack, i, stackEnd, stack0, t2, mul_sum, shg_sum, y, p, yi, yw, rbs, pr, r_out_sum, t3, pg, g_out_sum, pb, b_out_sum, r_sum, g_sum, b_sum, r_in_sum, g_in_sum, b_in_sum, stackOut, stackIn, x, t4, t5, t6, yp;
    t1 = J.getInterceptor$x(context);
    width = t1.get$canvas(context).width;
    height = t1.get$canvas(context).height;
    imageData = t1.getImageData$4(context, 0, 0, width, height);
    pixels = J.get$data$x(imageData);
    div = radius + radius + 1;
    ...
    stackStart = new N.BlurStack(null, null, null, null);
    for (stack = stackStart, i = 1, stackEnd = null; i < div; ++i, stack = stack0) {
      stack0 = new N.BlurStack(null, null, null, null);
      stack.next = stack0;
      if (i === radiusPlus1)
        stackEnd = stack0;
    }
    ...
    if (radius < 0 || radius >= 255)
      return H.ioore(t2, radius);
    mul_sum = t2[radius];
    shg_sum = $.get$shg_table()[radius];
    for (t2 = pixels.length, y = 0, p = null, yi = 0, yw = 0, rbs = null; y < height; ++y) {
      if (yi < 0 || yi >= t2)
        return H.ioore(pixels, yi);
      pr = pixels[yi];
      ...
      g_sum = sumFactor * pg;
      b_sum = sumFactor * pb;
      for (stack = stackStart, i = 0; i < radiusPlus1; ++i) {
        stack.r = pr;
        stack.g = pg;
        stack.b = pb;
        stack = stack.next;
      }
      for (i = 1, r_in_sum = 0, g_in_sum = 0, b_in_sum = 0; i < radiusPlus1; ++i) {
        p = yi + ((widthMinus1 < i ? widthMinus1 : i) << 2 >>> 0);
        if (p >= t2)
          return H.ioore(pixels, p);
        pr = pixels[p];
        stack.r = pr;
        rbs = radiusPlus1 - i;
        r_sum += pr * rbs;
      ...
      for (stackOut = stackEnd, stackIn = stackStart, x = 0; x < width; ++x) {
        t3 = C.JSInt_methods._shrOtherPositive$1(C.JSNumber_methods.toInt$0(Math.floor(r_sum * mul_sum)), shg_sum);
        if (yi >= t2)
          return H.ioore(pixels, yi);
        pixels[yi] = t3;
        t3 = yi + 1;
        t4 = C.JSInt_methods._shrOtherPositive$1(C.JSNumber_methods.toInt$0(Math.floor(g_sum * mul_sum)), shg_sum);
        if (t3 >= t2)
          return H.ioore(pixels, t3);
        pixels[t3] = t4;
        t4 = yi + 2;
        t3 = C.JSInt_methods._shrOtherPositive$1(C.JSNumber_methods.toInt$0(Math.floor(b_sum * mul_sum)), shg_sum);
        if (t4 >= t2)
        ...
        if (typeof t5 !== "number")
          return H.iae(t5);
        p = x + radius + 1;
        p = yw + (p < widthMinus1 ? p : widthMinus1) << 2 >>> 0;
        if (p >= t2)
          return H.ioore(pixels, p);
        t6 = pixels[p];
        stackIn.r = t6;
        ...
        stackIn.b = t6;
        b_in_sum += t6;
        r_sum = r_sum - r_out_sum + r_in_sum;
        g_sum = g_sum - g_out_sum + g_in_sum;
        b_sum = b_sum - b_out_sum + b_in_sum;
        stackIn = stackIn.next;
        pr = stackOut.r;
        if (typeof pr !== "number")
          return H.iae(pr);
        r_out_sum = r_out_sum - t3 + pr;
        pg = stackOut.g;
        if (typeof pg !== "number")
          return H.iae(pg);
        g_out_sum = g_out_sum - t4 + pg;
        pb = stackOut.b;
        if (typeof pb !== "number")
          return H.iae(pb);
        b_out_sum = b_out_sum - t5 + pb;
        r_in_sum -= pr;
        g_in_sum -= pg;
        b_in_sum -= pb;
    ...
    for (x = 0; x < width; ++x) {
      ...
      for (yp = width, i = 1, r_in_sum = 0, g_in_sum = 0, b_in_sum = 0; i <= radius; ++i) {
        yi = yp + x << 2 >>> 0;
        if (yi >= t2)
          return H.ioore(pixels, yi);
        pr = pixels[yi];
      ...
      for (stackOut = stackEnd, stackIn = stackStart, yi = x, y = 0; y < height; ++y) {
        p = yi << 2 >>> 0;
        t3 = C.JSInt_methods._shrOtherPositive$1(C.JSNumber_methods.toInt$0(Math.floor(r_sum * mul_sum)), shg_sum);
        if (p >= t2)
          return H.ioore(pixels, p);
        ...
        if (typeof t5 !== "number")
          return H.iae(t5);
        p = y + radiusPlus1;
        p = x + (p < heightMinus1 ? p : heightMinus1) * width << 2 >>> 0;
        if (p >= t2)
          return H.ioore(pixels, p);
        t6 = pixels[p];
        stackIn.r = t6;
    ...
    t1.putImageData$3(context, imageData, 0, 0);
  },
  BlurStack: {
    "^": "Object;r,g,b,next"
  }
...
["", "script/events.dart", , F, {
  ...
  EventTarget: {
    ...
    off$2: function($name, listener) {
      if (this._listeners.containsKey$1($name)) {
        J.remove$1$ax(this._listeners.$index(0, $name), listener);
        if (J.get$isEmpty$asx(this._listeners.$index(0, $name)) === true)
          this._listeners.remove$1(0, $name);
      }
      if (this._oneListeners.containsKey$1($name)) {
        J.remove$1$ax(this._oneListeners.$index(0, $name), listener);
        if (J.get$isEmpty$asx(this._oneListeners.$index(0, $name)) === true)
          this._oneListeners.remove$1(0, $name);
      }
    },
...
["images", "script/images.dart", , S, {
  ...
  loadImage_closure: {
    ...
    call$1: [function(e) {
      this.comp_0.complete$1(0, this.img_1);
...
["keys", "script/keys.dart", , F, {
  ...
  init: function() {
    ...
    t1.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, "keydown", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.init_closure3()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = document.body;
    t1.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, "keyup", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.init_closure4()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  },
  init_closure3: {
    "^": "Closure:28;",
    call$1: [function(e) {
...
["levels", "script/levels.dart", , V, {
  "^": "",
  addLevel: function(passWord, level) {
    $.get$levels().push(level);
    if (passWord != null)
      $.get$passMap().$indexSet(0, passWord, $.get$levels().length - 1);
  },
  passwordTest: [function(passWord) {
    return $.get$passMap().containsKey$1(passWord) ? $.get$passMap().$index(0, passWord) : -1;
  }, "call$1", "passwordTest$closure", 2, 0, 32, 33],
  init2: function() {
    var t1, ctx, t2;
    t1 = {};
    ctx = new X.Context(V.passwordTest$closure(), V.next$closure(), V.goTo$closure());
    t2 = new F.LevelTitle(null, null, null, null, null, null, null);
    t2.LevelTitle$3$soundName(ctx, 750, "bastacorp");
    V.addLevel(null, t2);
    t2 = new T.LevelMenu(null, null, null, null, null, null, 0, "", null, null);
    t2.LevelMenu$1(ctx);
    V.addLevel(null, t2);
    t1.i_0 = 0;
  ...
  goTo: [function(level) {
    ...
    if (t1 >>> 0 !== t1 || t1 >= t2.length)
      return H.ioore(t2, t1);
    t2[t1].reset$0(0);
  }, "call$1", "goTo$closure", 2, 0, 34],
  next: [function() {
    var nextLevel = J.$add$ns($.CURRENT_LEVEL, 1);
    if (J.$eq(nextLevel, $.get$levels().length))
      nextLevel = 0;
    V.goTo(nextLevel);
    $.CURRENT_LEVEL = nextLevel;
  }, "call$0", "next$closure", 0, 0, 11],
  init_closure: {
    "^": "Closure:28;box_0,ctx_1",
    call$1: function(level) {
      var password, t1, t2, t3, t4;
      password = level.containsKey$1("password") ? J.$index$asx(level, "password") : null;
      if (level.containsKey$1("message")) {
        t1 = J.$index$asx(level, "message");
        t2 = new Z.LevelMessage(null, null, null, null, null, null);
        t2.ctx = this.ctx_1;
        t2.duration = 2000;
        t2.message = t1;
        V.addLevel(password, t2);
        password = null;
      }
      t1 = this.ctx_1;
      t2 = this.box_0;
      t3 = J.getInterceptor$asx(level);
      V.addLevel(password, U.LevelSlidePuzzle$(t1, C.JSInt_methods.$mod(t2.i_0, 4), t3.$index(level, "width"), t3.$index(level, "height"), t3.$index(level, "content")));
      t4 = new Z.LevelMessage(null, null, null, null, null, null);
      t4.ctx = t1;
      t4.duration = 2000;
      t4.message = "Photo Op!";
      V.addLevel(null, t4);
      t4 = new Q.LevelPhoto(null, null, null, null, null, null, null, null, null, null);
...
["levels.generic", "script/level.generic.dart", , X, {
  ...
  Context: {
    "^": "Object;passwordTest,nextLevel,$goto",
    passwordTest$1: function(arg0) {
      return this.passwordTest.call$1(arg0);
    },
    nextLevel$0: function() {
      return this.nextLevel.call$0();
    },
...
["levels.menu", "script/level.menu.dart", , T, {
  "^": "",
  LevelMenu: {
    "^": "Level;ctx,bgImage,hubbleImage,duration,ended,jump,pointerIndex,passwordVal,height,width",
    reset$0: function(_) {
      this.ended = false;
      this.jump = 0;
      this.pointerIndex = 0;
      this.passwordVal = "";
      $.get$up().on$2(0, 40, this.get$handleDown());
      $.get$up().on$2(0, 38, this.get$handleUp());
      $.get$up().on$2(0, 13, this.get$handleSelect());
      $.get$up().on$2(0, "any", this.get$handleKey());
    },
    cleanUp$0: function() {
      $.get$up().off$2(40, this.get$handleDown());
      $.get$up().off$2(38, this.get$handleUp());
      $.get$up().off$2(13, this.get$handleSelect());
      $.get$up().off$2("any", this.get$handleKey());
    },
    handleUp$1: [function(e) {
      this.pointerIndex = this.pointerIndex === 0 ? 1 : 0;
      $._jsfxInst.callMethod$2("playSample", [$.get$samples().$index(0, "menu_up")]);
    }, "call$1", "get$handleUp", 2, 0, 12, 2],
    handleDown$1: [function(e) {
      this.pointerIndex = this.pointerIndex === 0 ? 1 : 0;
      $._jsfxInst.callMethod$2("playSample", [$.get$samples().$index(0, "menu_down")]);
    }, "call$1", "get$handleDown", 2, 0, 12, 2],
    handleSelect$1: [function(e) {
      var t1, level;
      t1 = this.pointerIndex;
      if (t1 === 0) {
        this.ended = true;
        $._jsfxInst.callMethod$2("playSample", [$.get$samples().$index(0, "select")]);
        return;
        ...
        t1 = this.passwordVal;
        if (t1.length !== 3) {
          $._jsfxInst.callMethod$2("playSample", [$.get$samples().$index(0, "invalid_choice")]);
          return;
        }
        level = this.ctx.passwordTest$1(t1);
        if (J.$eq(level, -1)) {
          $._jsfxInst.callMethod$2("playSample", [$.get$samples().$index(0, "bad_choice")]);
          return;
        }
    ...
    }, "call$1", "get$handleSelect", 2, 0, 12, 2],
    handleKey$1: [function(e) {
      var t1, t2;
      if (this.pointerIndex === 0)
        return;
      t1 = J.getInterceptor$x(e);
      if (t1.get$keyCode(e) === 8) {
        t1.preventDefault$0(e);
        t1 = this.passwordVal;
        t2 = t1.length;
        if (t2 === 0) {
        ...
        this.passwordVal = C.JSString_methods.substring$2(t1, 0, t2 - 1);
        $._jsfxInst.callMethod$2("playSample", [$.get$samples().$index(0, "backspace")]);
        return;
      }
      if ($.get$CHAR_CODES().containsKey$1(t1.get$keyCode(e))) {
        t2 = this.passwordVal;
        if (t2.length === 3) {
          $._jsfxInst.callMethod$2("playSample", [$.get$samples().$index(0, "invalid_choice")]);
          return;
        }
        this.passwordVal = C.JSString_methods.$add(t2, $.get$CHAR_CODES().$index(0, t1.get$keyCode(e)));
        $._jsfxInst.callMethod$2("playSample", [$.get$samples().$index(0, "keypress")]);
      }
    }, "call$1", "get$handleKey", 2, 0, 12, 2],
    draw$2: function(ctx, drawUI) {
      var t1, t2, canvas, t3, t4, t5, t6, t7;
      t1 = {};
      t2 = J.getInterceptor$x(ctx);
      t2.set$fillStyle(ctx, "#000");
      t2.fillRect$4(ctx, 0, 0, t2.get$canvas(ctx).width, t2.get$canvas(ctx).height);
      canvas = t2.get$canvas(ctx);
      t3 = Date.now();
      t1.finalWidth_0 = null;
      t1.finalHeight_1 = null;
      t1.hw_2 = null;
      t1.hh_3 = null;
      t4 = this.bgImage.fetched;
      if (t4 != null)
        new T.LevelMenu_draw_closure(t1, ctx, canvas).call$1(t4);
      t4 = this.hubbleImage.fetched;
      if (t4 != null)
        new T.LevelMenu_draw_closure0(t1, ctx, canvas, t3).call$1(t4);
      t2.set$fillStyle(ctx, "#fff");
      t2.set$font(ctx, "50px VT323");
      t3 = (this.pointerIndex === 0 ? "> " : "  ") + "START GAME";
      t4 = canvas.width;
      if (typeof t4 !== "number")
        return t4.$div();
      t5 = t1.hw_2;
      ...
      if (typeof t7 !== "number")
        return H.iae(t7);
      t2.fillText$3(ctx, t3, t4 / 2 - t5 + 10, t6 / 2 + t7 - 120);
      t3 = (this.pointerIndex === 1 ? "> " : "  ") + "PASSWORD: " + this.passwordVal;
      t4 = canvas.width;
      if (typeof t4 !== "number")
        return t4.$div();
      t5 = t1.hw_2;
      ...
      if (typeof t1 !== "number")
        return H.iae(t1);
      t2.fillText$3(ctx, t3, t4 / 2 - t5 + 10, t6 / 2 + t1 - 60);
    },
    tick$1: function(delta) {
      var t1, t2;
      if (this.ended === true) {
    ...
    LevelMenu$1: function(ctx) {
      this.ctx = ctx;
      this.bgImage = S.Drawable$("menu");
      this.hubbleImage = S.Drawable$("menu_hubble");
    }
  },
  LevelMenu_draw_closure: {
    "^": "Closure:28;box_0,ctx_1,canvas_2",
    call$1: function(img) {
      var t1, t2, t3, t4, t5, fitYWidth, fitYHeight, fitXWidth, fitXHeight, xOrY, finalWidth, finalHeight, t6, t7;
      t1 = this.canvas_2;
      t2 = t1.height;
      t3 = J.getInterceptor$x(img);
      t4 = t3.get$height(img);
      if (typeof t2 !== "number")
        return t2.$div();
      if (typeof t4 !== "number")
        return H.iae(t4);
      ...
      if (typeof t5 !== "number")
        return H.iae(t5);
      fitYWidth = t2 / t4 * t5;
      fitYHeight = t1.height;
      fitXWidth = t1.width;
      t5 = t3.get$width(img);
      if (typeof fitXWidth !== "number")
        return fitXWidth.$div();
      if (typeof t5 !== "number")
        return H.iae(t5);
      t4 = t3.get$height(img);
      if (typeof t4 !== "number")
        return H.iae(t4);
      fitXHeight = fitXWidth / t5 * t4;
      t4 = t1.width;
      if (typeof t4 !== "number")
        return H.iae(t4);
      xOrY = fitYWidth > t4;
      if (xOrY)
        finalWidth = fitXWidth;
      else
        finalWidth = fitYWidth;
      t2 = this.box_0;
      t2.finalWidth_0 = finalWidth;
      finalHeight = xOrY ? fitXHeight : fitYHeight;
      t2.finalHeight_1 = finalHeight;
      t2.hw_2 = finalWidth / 2;
      if (typeof finalHeight !== "number")
        return finalHeight.$div();
      t2.hh_3 = finalHeight / 2;
      t4 = t3.get$width(img);
      ...
      if (typeof t7 !== "number")
        return H.iae(t7);
      J.drawImageScaledFromSource$9$x(this.ctx_1, img, 0, 0, t4, t3, t5 / 2 - t6, t1 / 2 - t7, t2.finalWidth_0, t2.finalHeight_1);
    }
  },
  LevelMenu_draw_closure0: {
    "^": "Closure:28;box_0,ctx_3,canvas_4,now_5",
    call$1: function(img) {
      ...
      if (typeof t3 !== "number")
        return t3.$mul();
      t2.translate$2(t1, t4 * 0.55, t3 * 0.6);
      t2.rotate$1(t1, C.JSNumber_methods.$mod(this.now_5 / 20000, 360));
      t3 = J.getInterceptor$x(img);
      t4 = t3.get$width(img);
      t3 = t3.get$height(img);
      t5 = this.box_0;
      ...
      if (typeof t5 !== "number")
        return t5.$mul();
      t2.drawImageScaledFromSource$9(t1, img, 0, 0, t4, t3, -1 * t6 / 2, -1 * t7 / 2, t8 * 0.5, t5 * 0.5);
      t2.restore$0(t1);
    }
  }
}],
["levels.message", "script/level.message.dart", , Z, {
  "^": "",
  LevelMessage: {
    "^": "Level;ctx,duration,message,ttl,height,width",
    reset$0: function(_) {
      this.ttl = this.duration;
      $.get$up().one$2("any", this.get$handleAny());
    },
    handleAny$1: [function(e) {
      this.ttl = 0;
    }, "call$1", "get$handleAny", 2, 0, 12, 2],
    cleanUp$0: function() {
      $.get$up().off$2("any", this.get$handleAny());
    },
    draw$2: function(ctx, drawUI) {
      var t1, t2, t3, t4, t5;
      t1 = J.getInterceptor$x(ctx);
      t1.set$fillStyle(ctx, "#111");
      t1.fillRect$4(ctx, 0, 0, t1.get$canvas(ctx).width, t1.get$canvas(ctx).height);
      t1.set$fillStyle(ctx, "#fff");
      t1.set$font(ctx, "40px VT323");
      t2 = this.message;
      t3 = t1.get$canvas(ctx).width;
      if (typeof t3 !== "number")
        return t3.$div();
      t4 = t1.measureText$1(ctx, this.message).width;
      if (typeof t4 !== "number")
        return t4.$div();
      t5 = t1.get$canvas(ctx).height;
      if (typeof t5 !== "number")
        return t5.$div();
      t1.fillText$3(ctx, t2, t3 / 2 - t4 / 2, t5 / 2 - 20);
    },
    tick$1: function(delta) {
      var t1 = this.ttl;
      if (typeof t1 !== "number")
...
["levels.photo", "script/level.photo.dart", , Q, {
  "^": "",
  LevelPhoto: {
    "^": "Level;ctx,bgImage,blurredImage,ttl,holdTimer,sliderVal,lastSliderVal,sliding,height,width",
    reset$0: function(_) {
      this.ttl = -1;
      this.holdTimer = -1;
      this.sliding = false;
      ...
      $.get$events().on$2(0, "down", this.get$handleMouseDown());
      $.get$events().on$2(0, "up", this.get$handleMouseUp());
      $.get$events().on$2(0, "move", this.get$handleMouseMove());
    },
    handleMouseDown$1: [function(e) {
      ...
      t3 = document.body;
      t3.toString;
      t3 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t3.clientHeight));
      if (typeof t2 !== "number")
        return t2.$sub();
      if (Math.abs(t2 - t3 * 0.75) > 35)
        return;
      t1 = t1.get$client(e);
      t1 = t1.get$x(t1);
      t2 = document.body;
      ...
      if (typeof t1 !== "number")
        return t1.$sub();
      if (Math.abs(t1 - (t2 / 2 - 150 + t3 * 3)) > 35)
        return;
      this.sliding = true;
    }, "call$1", "get$handleMouseDown", 2, 0, 12, 2],
    handleMouseUp$1: [function(e) {
      ...
      if (this.ttl !== -1)
        return;
      this.sliding = false;
    }, "call$1", "get$handleMouseUp", 2, 0, 12, 2],
    handleMouseMove$1: [function(e) {
      ...
      if (val < 0)
        ...
        val = 100;
      this.sliderVal = val;
    }, "call$1", "get$handleMouseMove", 2, 0, 12, 2],
    cleanUp$0: function() {
      $.get$events().off$2("down", this.get$handleMouseDown());
      $.get$events().off$2("up", this.get$handleMouseUp());
      $.get$events().off$2("move", this.get$handleMouseMove());
    },
    draw$2: function(ctx, drawUI) {
      var t1, canvas, t2, t3, t4, fitYWidth, fitYHeight, fitXWidth, fitXHeight, xOrY, finalWidth, finalHeight;
      t1 = J.getInterceptor$x(ctx);
      canvas = t1.get$canvas(ctx);
      t1.set$fillStyle(ctx, "#111");
      t1.fillRect$4(ctx, 0, 0, t1.get$canvas(ctx).width, t1.get$canvas(ctx).height);
      t2 = canvas.height;
      t3 = J.get$canvas$x(this.blurredImage).height;
      if (typeof t2 !== "number")
        return t2.$div();
      if (typeof t3 !== "number")
        return H.iae(t3);
      t4 = J.get$canvas$x(this.blurredImage).width;
      if (typeof t4 !== "number")
        return H.iae(t4);
      fitYWidth = t2 / t3 * t4;
      fitYHeight = canvas.height;
      fitXWidth = canvas.width;
      t4 = J.get$canvas$x(this.blurredImage).width;
      if (typeof fitXWidth !== "number")
        return fitXWidth.$div();
      if (typeof t4 !== "number")
      ...
      if (typeof finalHeight !== "number")
        return finalHeight.$div();
      t2 = J.get$canvas$x(this.blurredImage);
      t3 = canvas.width;
      if (typeof t3 !== "number")
        return t3.$div();
      t4 = canvas.height;
      if (typeof t4 !== "number")
        return t4.$div();
      t1.drawImageScaledFromSource$9(ctx, t2, 0, 0, 512, 512, t3 / 2 - finalWidth / 2, t4 / 2 - finalHeight / 2, finalWidth, finalHeight);
      if (this.ttl !== -1)
        return;
      t1.set$fillStyle(ctx, "#333");
      t2 = document.body;
      t2.toString;
      t2 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t2.clientWidth));
      t3 = document.body;
      t3.toString;
      t1.fillRect$4(ctx, t2 / 2 - 150, C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t3.clientHeight)) * 0.75 - 5, 300, 10);
      t1.set$fillStyle(ctx, "#aaa");
      t3 = document.body;
      t3.toString;
      t3 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t3.clientWidth));
      t2 = this.sliderVal;
      if (typeof t2 !== "number")
        return t2.$mul();
      t4 = document.body;
      t4.toString;
      t1.fillRect$4(ctx, t3 / 2 - 150 + t2 * 3 - 35, C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t4.clientHeight)) * 0.75 - 35, 70, 70);
    },
    tick$1: function(delta) {
      var t1, t2;
      t1 = this.ttl;
      ...
      t1 = this.sliderVal;
      t2 = this.lastSliderVal;
      if (t1 == null ? t2 != null : t1 !== t2) {
        t1 = this.bgImage.fetched;
        if (t1 != null)
          new Q.LevelPhoto_tick_closure(this).call$1(t1);
        $._jsfxInst.callMethod$2("playSample", [$.get$samples().$index(0, "tick")]);
      ...
      if (t1 !== -1) {
        ...
        if (t1 <= 0) {
          ...
          t1 = this.bgImage.fetched;
          if (t1 != null)
            new Q.LevelPhoto_tick_closure0(this).call$1(t1);
          this.ttl = 1000;
          return;
        }
      }
    },
    LevelPhoto$2: function(ctx, image) {
      this.ctx = ctx;
      this.bgImage = S.Drawable$(image);
      this.blurredImage = N.getBuffer(512, 512);
    }
  },
  LevelPhoto_tick_closure: {
    "^": "Closure:28;this_0",
    call$1: function(img) {
      var t1, t2, radius;
      t1 = this.this_0;
      J.drawImage$3$x(t1.blurredImage, img, 0, 0);
      t2 = t1.sliderVal;
      if (typeof t2 !== "number")
        return t2.$sub();
      radius = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(Math.abs(t2 - 50)));
      if (radius !== 0)
        N.blur(t1.blurredImage, radius);
      if (radius < 3 && t1.holdTimer === -1)
        t1.holdTimer = 1500;
      else if (radius > 3)
        t1.holdTimer = -1;
    }
  },
  LevelPhoto_tick_closure0: {
    "^": "Closure:28;this_1",
    call$1: function(img) {
      J.drawImage$3$x(this.this_1.blurredImage, img, 0, 0);
    }
  }
}],
["levels.slidePuzzle", "script/level.slidePuzzle.dart", , U, {
  "^": "",
  LevelSlidePuzzle: {
    "^": "Level;ctx,bgImage,playerSprite,trinketSprite,board,data,trinketIndex,width:slidePuzzle$LevelSlidePuzzle$width>,height:slidePuzzle$LevelSlidePuzzle$height>,duration,startX,startY,endX,endY,playerX,playerY,playerSliding,playerVelX,playerVelY,playerDirX,playerDirY,won,height,width",
    getLevelIndex$2: function(x, y) {
      var t1;
      if (x < 0)
        x = 0;
      else {
        t1 = this.slidePuzzle$LevelSlidePuzzle$width;
        if (typeof t1 !== "number")
          return H.iae(t1);
        if (x >= t1)
          x = t1 - 1;
      ...
      if (y < 0)
        ...
        t1 = this.slidePuzzle$LevelSlidePuzzle$height;
        if (typeof t1 !== "number")
          return H.iae(t1);
        if (y >= t1)
          y = t1 - 1;
    ...
    doSlide$2: function(dx, dy) {
      var t1, t2, t3;
      if (!this.playerCanMove$2(dx, dy))
        return;
      this.playerDirX = dx;
      this.playerDirY = dy;
      t1 = dx * 0.01;
      ...
      $._jsfxInst.callMethod$2("playSample", [$.get$samples().$index(0, "move")]);
    },
    playerCanMove$2: function(dx, dy) {
      var t1, t2;
      if (typeof dx !== "number")
        return dx.$lt();
      if (dx < 0 && C.JSNumber_methods.toInt$0(J.roundToDouble$0$n(this.playerX)) === 0)
        return false;
      if (dx > 0 && C.JSNumber_methods.toInt$0(J.roundToDouble$0$n(this.playerX)) === J.$sub$n(this.slidePuzzle$LevelSlidePuzzle$width, 1))
        return false;
      if (typeof dy !== "number")
        return dy.$lt();
      if (dy < 0 && C.JSNumber_methods.toInt$0(J.roundToDouble$0$n(this.playerY)) === 0)
        return false;
      if (dy > 0 && C.JSNumber_methods.toInt$0(J.roundToDouble$0$n(this.playerY)) === J.$sub$n(this.slidePuzzle$LevelSlidePuzzle$height, 1))
        return false;
      t1 = this.data;
      t2 = this.getLevelIndex$2(C.JSNumber_methods.toInt$0(J.roundToDouble$0$n(this.playerX)) + dx, C.JSNumber_methods.toInt$0(J.roundToDouble$0$n(this.playerY)) + dy);
      if (t2 >>> 0 !== t2 || t2 >= t1.length)
        return H.ioore(t1, t2);
      t2 = t1[t2];
      return !$.get$SOLID().contains$1(0, t2);
    },
    draw$2: function(ctx, drawUI) {
      var t1, t2, canvas, t3, tileSize;
      t1 = {};
      t2 = J.getInterceptor$x(ctx);
      t2.set$fillStyle(ctx, "#000");
      t2.fillRect$4(ctx, 0, 0, t2.get$canvas(ctx).width, t2.get$canvas(ctx).height);
      ...
      t1.offsetX_2 = null;
      t1.offsetY_3 = null;
      t3 = this.bgImage.fetched;
      if (t3 != null)
        new U.LevelSlidePuzzle_draw_closure(t1, ctx, canvas).call$1(t3);
      t2.drawImageScaledFromSource$9(ctx, J.get$canvas$x(this.board), 0, 0, J.get$canvas$x(this.board).width, J.get$canvas$x(this.board).height, t1.offsetX_2, t1.offsetY_3, t1.finalWidth_0, t1.finalHeight_1);
      t2 = t1.finalWidth_0;
      t3 = this.slidePuzzle$LevelSlidePuzzle$width;
      if (typeof t2 !== "number")
        return t2.$div();
      if (typeof t3 !== "number")
        return H.iae(t3);
      tileSize = t2 / t3;
      if (this.won === 0) {
        t2 = this.trinketSprite.fetched;
        if (t2 != null)
          new U.LevelSlidePuzzle_draw_closure0(t1, this, ctx, tileSize).call$1(t2);
      }
      t2 = this.playerSprite.fetched;
      if (t2 != null)
        new U.LevelSlidePuzzle_draw_closure1(t1, this, ctx, tileSize).call$1(t2);
    },
    tick$1: function(delta) {
      var t1, origPlayerX, origPlayerY, t2, t3;
      t1 = this.won;
      if (t1 !== 0) {
        if (typeof t1 !== "number")
          return t1.$sub();
      ...
      if (this.playerSliding !== true)
        return;
      origPlayerX = this.playerX;
      origPlayerY = this.playerY;
      t1 = this.playerVelX;
      if (typeof t1 !== "number")
        return t1.$mul();
      if (typeof origPlayerX !== "number")
        return origPlayerX.$add();
      this.playerX = origPlayerX + t1 * delta;
      t1 = this.playerVelY;
      if (typeof t1 !== "number")
        return t1.$mul();
      if (typeof origPlayerY !== "number")
        return origPlayerY.$add();
      this.playerY = origPlayerY + t1 * delta;
      t1 = C.JSNumber_methods.toInt$0(Math.floor(origPlayerX));
      t2 = this.playerX;
      t2.toString;
      if (t1 === C.JSNumber_methods.toInt$0(Math.floor(t2))) {
        t1 = C.JSNumber_methods.toInt$0(Math.floor(origPlayerY));
        t2 = this.playerY;
        t2.toString;
        t2 = t1 !== C.JSNumber_methods.toInt$0(Math.floor(t2));
        t1 = t2;
      } else
        t1 = true;
      if (t1)
        if (!this.playerCanMove$2(this.playerDirX, this.playerDirY)) {
          this.playerDirX = 0;
          this.playerDirY = 0;
          this.playerVelX = 0;
          this.playerVelY = 0;
          this.playerX = J.roundToDouble$0$n(this.playerX);
          t1 = J.roundToDouble$0$n(this.playerY);
          this.playerY = t1;
          this.playerSliding = false;
          t2 = this.playerX;
          t3 = this.endX;
          if ((t2 == null ? t3 == null : t2 === t3) && t1 === this.endY) {
            $._jsfxInst.callMethod$2("playSample", [$.get$samples().$index(0, "select")]);
            this.won = 500;
            return;
          }
          $._jsfxInst.callMethod$2("playSample", [$.get$samples().$index(0, "bump")]);
          return;
        }
    },
    LevelSlidePuzzle$5: function(ctx, trinketIndex, width, height, data) {
      var t1, convertedData, t2, t3, t4, i;
      this.ctx = ctx;
      this.trinketIndex = trinketIndex;
      this.slidePuzzle$LevelSlidePuzzle$width = width;
      this.slidePuzzle$LevelSlidePuzzle$height = height;
      this.bgImage = S.Drawable$("space");
      this.playerSprite = S.Drawable$("player");
      this.trinketSprite = S.Drawable$("trinkets");
      t1 = J.getInterceptor$ns(width);
      this.data = new Uint16Array(H._checkLength(t1.$mul(width, height)));
      if (data != null) {
        convertedData = D.base64DecToArr(data);
        for (t2 = this.data, t3 = t2.length, t4 = convertedData.length, i = 0; i < t3; ++i) {
          if (i >= t4)
            return H.ioore(convertedData, i);
          t2[i] = convertedData[i];
        }
      }
      this.board = N.getBuffer(t1.$mul(width, 16), J.$mul$ns(height, 16));
      S.Drawable$("tiles").future.then$1(new U.LevelSlidePuzzle_closure(this, width, height));
    },
    static: {LevelSlidePuzzle$: function(ctx, trinketIndex, width, height, data) {
        var t1 = new U.LevelSlidePuzzle(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        t1.LevelSlidePuzzle$5(ctx, trinketIndex, width, height, data);
        return t1;
      }}
  },
  LevelSlidePuzzle_closure: {
    "^": "Closure:28;this_0,width_1,height_2",
    call$1: [function(img) {
      var t1, t2, t3, tile, tileImg, x, t4, y, t5, t6;
      t1 = this.width_1;
      if (typeof t1 !== "number")
        return H.iae(t1);
      t2 = this.height_2;
      ...
      for (; x < t1; ++x) {
        ...
        for (; y < t2; ++y) {
          ...
          if (typeof t6 !== "number")
            return H.iae(t6);
          J.drawImageScaledFromSource$9$x(t5, img, C.JSInt_methods.$mod(tileImg, t6) * 16, C.JSNumber_methods.toInt$0(Math.floor(tileImg / t6)) * 16, 16, 16, t4, y * 16, 16, 16);
        }
      }
    }, "call$1", null, 2, 0, null, 59, "call"]
  },
  LevelSlidePuzzle_draw_closure: {
    "^": "Closure:28;box_0,ctx_1,canvas_2",
    call$1: function(img) {
      var t1, t2, t3, t4, t5, fitYWidth, fitYHeight, fitXWidth, fitXHeight, xOrY, finalWidth, finalHeight;
      t1 = this.canvas_2;
      t2 = t1.height;
      t3 = J.getInterceptor$x(img);
      t4 = t3.get$height(img);
      ...
      if (typeof t4 !== "number")
        return t4.$div();
      t2.offsetX_2 = t4 / 2 - finalWidth / 2;
      t1 = t1.height;
      if (typeof t1 !== "number")
        return t1.$div();
      t2.offsetY_3 = t1 / 2 - finalHeight / 2;
      J.drawImageScaledFromSource$9$x(this.ctx_1, img, 0, 0, t3.get$width(img), t3.get$height(img), t2.offsetX_2, t2.offsetY_3, t2.finalWidth_0, t2.finalHeight_1);
    }
  },
  LevelSlidePuzzle_draw_closure0: {
    "^": "Closure:28;box_0,this_3,ctx_4,tileSize_5",
    call$1: function(img) {
      var t1, t2, wiggleVal, t3, t4, t5, t6, t7, t8, t9;
      t1 = Date.now();
      t2 = this.tileSize_5;
      wiggleVal = t2 / 16;
      t3 = this.this_3;
      t4 = t3.trinketIndex;
      t5 = C.JSInt_methods.$mod(t4, 2);
      t4 = C.JSNumber_methods.toInt$0(Math.floor(t4 / 2));
      t6 = this.box_0;
      t7 = t6.offsetX_2;
      t8 = t3.endX;
      if (typeof t8 !== "number")
      ...
      if (typeof t7 !== "number")
        return t7.$add();
      t1 /= 2;
      t9 = C.JSInt_methods.$mod(C.JSNumber_methods.toInt$0(Math.floor(C.JSNumber_methods.$mod(t1, 976) / 250)), 3);
      t6 = t6.offsetY_3;
      t3 = t3.endY;
      if (typeof t3 !== "number")
        return H.iae(t3);
      if (typeof t6 !== "number")
        return t6.$add();
      J.drawImageScaledFromSource$9$x(this.ctx_4, img, t5 * 16, t4 * 16, 16, 16, t7 + t2 * t8 + (t9 - 1) * wiggleVal, t6 + t2 * t3 + (C.JSInt_methods.$mod(C.JSNumber_methods.toInt$0(Math.floor(C.JSNumber_methods.$mod(t1, 873) / 250)), 3) - 1) * wiggleVal, t2, t2);
    }
  },
  LevelSlidePuzzle_draw_closure1: {
    "^": "Closure:28;box_0,this_6,ctx_7,tileSize_8",
    call$1: function(img) {
      var t1, t2, t3, t4, t5;
      t1 = this.box_0;
      t2 = t1.offsetX_2;
      ...
      if (typeof t1 !== "number")
        return t1.$add();
      J.drawImageScaledFromSource$9$x(this.ctx_7, img, 0, 0, 16, 16, t2 + t3 * t5, t1 + t3 * t4, t3, t3);
    }
  }
}],
["levels.title", "script/level.title.dart", , F, {
  "^": "",
  LevelTitle: {
    "^": "Level;ctx,image,duration,soundName,ttl,height,width",
    reset$0: function(_) {
    ...
    LevelTitle$3$soundName: function(ctx, duration, soundName) {
      this.ctx = ctx;
      this.image = S.Drawable$("bastacorp");
...
1],
["mouse", "script/mouse.dart", , R, {
  "^": "",
  init0: function() {
    var t1 = document.body;
    t1.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, "mousedown", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.init_closure0()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = document.body;
    t1.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, "mouseup", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.init_closure1()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = document.body;
    t1.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, "mousemove", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.init_closure2()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  },
  init_closure0: {
    "^": "Closure:28;",
    call$1: [function(e) {
      $.get$events().fire$2("down", e);
    }, "call$1", null, 2, 0, null, 2, "call"]
  },
  init_closure1: {
    "^": "Closure:28;",
    call$1: [function(e) {
      $.get$events().fire$2("up", e);
    }, "call$1", null, 2, 0, null, 2, "call"]
  },
  init_closure2: {
    "^": "Closure:28;",
    call$1: [function(e) {
      $.get$events().fire$2("move", e);
    }, "call$1", null, 2, 0, null, 2, "call"]
  }
}],
...
["", "script/timing.dart", , E, {
  ...
  _loop: [function(ts) {
    ...
    $.previous = t1;
  }, "call$1", "_loop$closure", 2, 0, 35, 36],
  start: function() {
    if ($.started)
      return;
    $.previous = Date.now();
  ...
  start_closure: {
    ...
    call$1: [function(e) {
      ...
      $._jsfxInst.callMethod$2("playSample", [$.get$samples().$index(0, "select")]);
      if ($.paused) {
        modifierWidth = J.measureText$1$x($._ctx, "Pause");
        ...
        if (typeof t3 !== "number")
          return t3.$div();
        J.fillText$3$x(t1, "Pause", t2 - t3 / 2 + 4, J.$div$n($._height, 2) - 30 + 4);
        ...
        if (typeof t1 !== "number")
          return t1.$div();
        J.fillText$3$x(t3, "Pause", t2 - t1 / 2, J.$div$n($._height, 2) - 30);
      }
    }, "call$1", null, 2, 0, null, 2, "call"]
  }
}],
...
Isolate.$lazy($, "mul_table", "mul_table", "get$mul_table", function() {
  return [512, 512, 456, 512, 328, 456, 335, 512, 405, 328, 271, 456, 388, 335, 292, 512, 454, 405, 364, 328, 298, 271, 496, 456, 420, 388, 360, 335, 312, 292, 273, 512, 482, 454, 428, 405, 383, 364, 345, 328, 312, 298, 284, 271, 259, 496, 475, 456, 437, 420, 404, 388, 374, 360, 347, 335, 323, 312, 302, 292, 282, 273, 265, 512, 497, 482, 468, 454, 441, 428, 417, 405, 394, 383, 373, 364, 354, 345, 337, 328, 320, 312, 305, 298, 291, 284, 278, 271, 265, 259, 507, 496, 485, 475, 465, 456, 446, 437, 428, 420, 412, 404, 396, 388, 381, 374, 367, 360, 354, 347, 341, 335, 329, 323, 318, 312, 307, 302, 297, 292, 287, 282, 278, 273, 269, 265, 261, 512, 505, 497, 489, 482, 475, 468, 461, 454, 447, 441, 435, 428, 422, 417, 411, 405, 399, 394, 389, 383, 378, 373, 368, 364, 359, 354, 350, 345, 341, 337, 332, 328, 324, 320, 316, 312, 309, 305, 301, 298, 294, 291, 287, 284, 281, 278, 274, 271, 268, 265, 262, 259, 257, 507, 501, 496, 491, 485, 480, 475, 470, 465, 460, 456, 451, 446, 442, 437, 433, 428, 424, 420, 416, 412, 408, 404, 400, 396, 392, 388, 385, 381, 377, 374, 370, 367, 363, 360, 357, 354, 350, 347, 344, 341, 338, 335, 332, 329, 326, 323, 320, 318, 315, 312, 310, 307, 304, 302, 299, 297, 294, 292, 289, 287, 285, 282, 280, 278, 275, 273, 271, 269, 267, 265, 263, 261, 259];
});
Isolate.$lazy($, "shg_table", "shg_table", "get$shg_table", function() {
...
Isolate.$lazy($, "IMAGES", "IMAGES", "get$IMAGES", function() {
  return P.LinkedHashMap_LinkedHashMap$_literal([1, 0, 2, 1, 3, 2, 4, 3, 5, 4, 13, 12, 14, 13], null, null);
});
Isolate.$lazy($, "SOLID", "SOLID", "get$SOLID", function() {
  var t1 = P.LinkedHashSet_LinkedHashSet(null, null, null, null);
  t1.addAll$1(0, [1, 2, 3, 4, 5]);
  return t1;
});
