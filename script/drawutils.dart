...
class TileMap {
    ...
    void render(Function renderer) {
        this.drawable.drawEventually(renderer);
    }
...
void blur(CanvasRenderingContext2D context, int radius) {
    ...
    for ( y = 0; y < height; y++ ) {
        ...
        stackOut = stackEnd;
        for ( x = 0; x < width; x++ ) {
            pixels[yi]   = (r_sum * mul_sum).floor() >> shg_sum;
            pixels[yi+1] = (g_sum * mul_sum).floor() >> shg_sum;
            pixels[yi+2] = (b_sum * mul_sum).floor() >> shg_sum;
    ...
    for ( x = 0; x < width; x++ ) {
        ...
        for ( y = 0; y < height; y++ ) {
            p = yi << 2;
            pixels[p]   = (r_sum * mul_sum).floor() >> shg_sum;
            pixels[p+1] = (g_sum * mul_sum).floor() >> shg_sum;
            pixels[p+2] = (b_sum * mul_sum).floor() >> shg_sum;
